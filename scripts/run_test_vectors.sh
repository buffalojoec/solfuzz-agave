...
find dump/test-vectors/txn/fixtures/precompile/secp256k1 -type f -name '*.fix' | xargs -P 32 -I {} ./target/release/test_exec_txn {} > $LOG_PATH/test_exec_precompile.log 2>&1
